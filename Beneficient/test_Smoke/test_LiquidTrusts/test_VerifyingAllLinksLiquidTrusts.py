...
def test_setup():
      ...
      TestName = "test_VerifyingAllLinksLiquidTrusts"
      description = "This is smoke test case to verify all sections inside Liquid Trusts modules"
      TestResult = []
      TestResultStatus = []
      TestDirectoryName = "test_LiquidTrusts"
...
@allure.description("Test case to verfiy all links at LiquidTrusts Page")
@allure.severity(severity_level="High")
def test_VerfyAllLinksLiquidTrustsPage(test_setup):
    PageName="Liquid Trusts"
    PageTitle="Liquid Trusts - BIDS"
