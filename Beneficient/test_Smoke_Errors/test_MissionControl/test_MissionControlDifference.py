        ...
        try:
            ...
            for ia in range(YearCounterNumber):
                ...
                rows = driver.find_elements_by_xpath(
                    "//div[@class='BoxLayout---box BoxLayout---margin_below_none BoxLayout---margin_above_none'][1]/div[2]/div/div/div[4]/div")
                ...
                for i in range(len(rows) + 1):
                    if i > 1:
                        ...
                        DifferenceValueString = driver.find_element_by_xpath(
                            "//div[@class='BoxLayout---box BoxLayout---margin_below_none BoxLayout---margin_above_none'][1]/div[2]/div/div/div[4]/div[" + str(
                                i) + "]/div[2]/p").text
                        ...
                        DifferenceValueStringOther = driver.find_element_by_xpath(
                            "//div[@class='BoxLayout---box BoxLayout---margin_below_none BoxLayout---margin_above_none'][2]/div[2]/div/div/div[4]/div[" + str(
                                              i) + "]/div[2]/div/p").text
