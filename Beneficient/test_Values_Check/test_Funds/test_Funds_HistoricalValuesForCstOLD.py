...
def test_Funds_Values(test_setup):
    if Exe == "Yes":
        ...
        driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div/div/div/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/div/div[2]/div/div[2]/div/div").click()
        time.sleep(1)
        ...
        FundsItems=driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div/div/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/span[3]").text
        ...
        for ii1 in range(TotalFundsItemsInt):
            ...
            for ii2 in range(1,8):
                try:
                    FundName=driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div/div/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[2]/div/div[1]/table/tbody/tr["+str(ii2)+"]/td[1]/div/p/a").text
