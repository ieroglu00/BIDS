...
def test_setup():
  ...
  TestName = "test_DealTemplate"
  description = "This test scenario is to verify presence and working of Deal Template section and its all elements inside Deal Template tab of Funds"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
  TestDirectoryName = "test_DealTemplate"
  Exe="Yes"
  Directory = 'test_DealTemplate/'
...
def test_VerifyAllClickables(test_setup):
    if Exe == "Yes":
        ...
        try:
            ...
            inside = "Deal Template"
            Type = "label"
            # --------------------Checking Potential Trust content--------------
            Text1 = "Potential Trust"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[3]/div[1]/div[1]/span").text
                assert Text1 in Element1, Text1 + " "+Type+" in "+ inside + " section is not present"
                TestResult.append(
                    Text1 + " "+Type+" in "+ inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "drop down"
            # --------------------Checking Potential Trust dropdown content--------------
            Text1 = "Potential Trust"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[3]/div[1]/div[2]/div/div/span").text
                assert "-- select --" in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            except Exception as e1:
            ...
            inside = "Deal Template"
            Type = "hyperlink text"
            # --------------------Checking Click to Approve Deal content--------------
            Text1 = "Click to Approve Deal"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[4]/div/div[2]/div/p").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "label"
            # --------------------Checking Deal Valuation Date content--------------
            Text1 = "Deal Valuation Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[5]/div/div[1]/span").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "drop down"
            # --------------------Checking Deal Valuation Date dropdown --------------
            Text1 = "Deal Valuation Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[5]/div/div[2]/div/div").is_displayed()
                assert True == Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            except Exception as e1:
            ...
            inside = "Deal Template"
            Type = "label"
            # --------------------Checking PT Ownership on Val. Date content--------------
            Text1 = "PT Ownership on Val. Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[6]/div/div[1]/label").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "drop down"
            # --------------------Checking PT Ownership on Val. Date dropdown--------------
            Text1 = "PT Ownership on Val. Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[6]/div/div[2]/div").is_displayed()
                assert True == Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "label"
            # --------------------Checking Fund Currency content--------------
            Text1 = "Fund Currency"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[7]/div/div[1]/label").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "drop down"
            # --------------------Checking Fund Currency dropdown--------------
            Text1 = "Fund Currency"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[7]/div/div[2]/div").is_displayed()
                assert True == Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "label"
            # --------------------Checking Local/USD on Val. Date content--------------
            Text1 = "Local/USD on Val. Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[8]/div/div[1]/label").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "drop down"
            # --------------------Checking Local/USD on Val. Date dropdown--------------
            Text1 = "Local/USD on Val. Date"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[8]/div/div[2]/div").is_displayed()
                assert True == Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            inside = "Deal Template"
            Type = "hyperlink text"
            # --------------------Checking Export to Excel--------------
            Text1 = "EXPORT TO EXCEL"
            try:
                Element1 = driver.find_element_by_xpath(
                    "//div[@class='ContentLayout---content_layout']/div[3]/div/div[1]/div/div/div/div[1]/div[9]/div/div/button").text
                assert Text1 in Element1, Text1 + " " + Type + " in " + inside + " section is not present"
                TestResult.append(
                    Text1 + " " + Type + " in " + inside + " section is present")
                TestResultStatus.append("Pass")
            ...
            # # --------------------Fetching all Funds to add in Sheet-----------------------------------
