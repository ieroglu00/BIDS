...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 4 ( Liquid Trust ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    msg = MIMEMultipart()
    msg['Subject']='Test Automation Report [Smoke Test 4 (Liquid Trust)] -Env [Test] '+date_str
    msg['From'] = email_from
