...
def test_setup():
  ...
  TestName = "test_CalenderInternalProject"
  description = "This test scenario is to verify elements and working of Calender (InternalProject) in Transactions"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
@pytest.mark.smoke
def test_CalenderInternalProject(test_setup):
    if Exe == "Yes":
        SHORT_TIMEOUT = 5
        LONG_TIMEOUT = 400
        ...
        try:
            ...
            # --------------To click Manage Internal Project Entries inside-----------------------
            driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[1]/div/div").click()
            time.sleep(1)

            # --------------To click Add Entry (Manage Internal Project Entries)-----------------------
            driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[2]/div/div/div[1]/div/div/div/div/div[2]/div/div[2]/div/div/a").click()
            time.sleep(1)
            ...
            AnalystNameFound=driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[2]/div/div/div[1]/div/div/div/div/div[2]/div/div[1]/table/tbody/tr[1]/th/div/div/span").text
            AnalystNameFound = "".join(AnalystNameFound.split())
            AnalystNameToCheck=AnalystNameFound+ProjectName
            print(AnalystNameToCheck)


            driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[2]/div/div/div[1]/div/div/div/div/div[2]/div/div[1]/table/tbody/tr[1]/td[1]/div/input").send_keys(ProjectName)
            ...
            driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[2]/div/div/div[1]/div/div/div/div/div[2]/div/div[1]/table/tbody/tr[1]/td[2]/div/div/input").send_keys(StartDate)
            time.sleep(1)
            driver.find_element_by_xpath("//div[@class='ContentLayout---content_layout']/div[2]/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div[3]/div[2]/div/div/div[1]/div/div/div/div/div[2]/div/div[1]/table/tbody/tr[1]/td[3]/div/div/input").send_keys(EndDate)
            time.sleep(1)
            ...
            TestResult.append("Internal Project added successfully")
            TestResultStatus.append("Pass")
                                ...
                                for ele in range(1, len(DateEle)):
                                    try:
                                        ...
                                        if AnalystNameToCheck==DateDatagot:
                                            ...
                                            Found="True"
                                            TestResult.append(
                                                "Created Internal Project verified successfully for Date [ " + StartDate + " ]")
                                            TestResultStatus.append("Pass")
                                            break
                                    except Exception:
                                        pass
            ...
            if Found == "False":
                TestResult.append(
                    "Created Internal Project not found for Date [ " + StartDate + " ]")
                TestResultStatus.append("Fail")
