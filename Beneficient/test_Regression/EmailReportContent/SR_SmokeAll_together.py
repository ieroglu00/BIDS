...
def test_ReportSendSmokeAll():
    ...
    SendStatus = []
    AttachmntAdded= []
    PDFpath = 'C:/BIDS/beneficienttest/Beneficient/test_Regression/'

    #-------------------To read content to send in e-Mail--------------------
    ExcelFileName = "FileName"
    loc = ('C:/BIDS/beneficienttest/Beneficient/test_Regression/PDFFileNameData/' + ExcelFileName + '.xlsx')
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 6 (To perform regression) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    msg = MIMEMultipart()
    msg['Subject']='Test Automation Report [Test Suite 6] -Env [Test] '+date_str
    msg['From'] = email_from
    ...
    #-----------------------------------------------------------------------
    try:
        attach_file_to_email(msg, 'C:/BIDS/beneficienttest/Beneficient/test_Regression/TestPieResult.png',
    ...
    for ii in range(0,len(PDFName1)):
        print()
        try:
            os.remove('C:/BIDS/beneficienttest/Beneficient/test_Regression/'+PDFName1[ii])
        except Exception:
            print("No Attachment found to delete")
    try:
        os.remove('C:/BIDS/beneficienttest/Beneficient/test_Regression/TestPieResult.png')
    except Exception:
        print("No Attachment found to delete")
    #-----------------------------------------------------------------------
    server.quit()
