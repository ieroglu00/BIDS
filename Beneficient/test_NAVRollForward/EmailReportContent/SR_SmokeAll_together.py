...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 9 ( NAV Roll Forward ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    msg = MIMEMultipart()
    msg['Subject']='[Smoke Test 9 ( NAV Roll Forward)]-Test Automation Report-Env [Test] '+date_str
    msg['From'] = email_from
