...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 12 ( Funds Balance Sheet ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    email_to =['Ismail.Eroglu@beneficient.com','srinath.jandhyala@beneficient.com','gregory.bybee@beneficient.com','olufunke.okeni@beneficient.com']
    ...
    msg = MIMEMultipart()
    msg['Subject']='[Smoke Test 12 ( Funds Balance Sheet )]-Test Automation Report-Env [Test] '+date_str
    msg['From'] = email_from
