...
def test_setup():
  ...
  TestName = "test_InitialDealScreen"
  description = "This test scenario is to verify presence of elements inside Initial Deal Screen"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
@pytest.mark.smoke
def test_InitialDealScreen(test_setup):
    if Exe == "Yes":
        try:
            SHORT_TIMEOUT = 5
            LONG_TIMEOUT = 400
            ...
            # ---------------------------------Initial Screening Recommendation present in page-------------------------------
            Text1 = "Initial Screening Recommendation"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[2]/div[2]/div/div[1]/div/div[1]/span").text
            try:
