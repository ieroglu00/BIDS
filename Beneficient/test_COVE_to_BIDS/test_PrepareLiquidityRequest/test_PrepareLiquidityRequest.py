...
def test_setup():
  ...
  TestName = "test_PrepareLiquidityRequest"
  description = "This test scenario is to verify presence of elements inside Prepare Liquidity Request"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Prepare Liquidity Request - Create/Associate Funds"
            ii = 4
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------As Indicated By Client present in page-------------------------------
            Text1 = "As Indicated By Client"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div/table/thead/tr/th[1]/div").text
            try:
            ...
            # ---------------------------------Add Fund button present in page-------------------------------
            Text1 = "Add Fund"
            Element1 = driver.find_element_by_xpath(
            ...
            # ---------------------------------Create New Funds button present in page-------------------------------
            Text1 = "Create New Funds"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[4]/div[2]/div/div[1]/div/div[2]/div/p/span/strong/a").text
            try:
                assert Text1 in Element1, Text1 + " button is not present"
                TestResult.append(
                    Text1 + " button is present")
