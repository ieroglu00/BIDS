...
def test_setup():
  ...
  TestName = "test_ReviewAndSendBottomUpCashFlowsToRisk"
  description = "This test scenario is to verify presence of elements inside Review and Send Bottom-Up Cash Flows to Risk"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Review and Send Bottom-Up Cash Flows to Risk"
            ii = 9
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Bottom-Up Cash Flow Version History present in page-------------------------------
            Text1 = "Bottom-Up Cash Flow Version History"
            ...
            # ---------------------------------Upload Bottom-Up Cash Flows present in page-------------------------------
            Text1 = "Upload Bottom-Up Cash Flows"
            Element1 = driver.find_element_by_xpath(
            ...
            # ---------------------------------BOTTOM UP CASH FLOWS SENT TO RISK button present in page-------------------------------
            Text1 = "BOTTOM UP CASHFLOW TO RISK"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div/div/div/div/div/div[3]/div[2]/div/div/button").text
            try:
