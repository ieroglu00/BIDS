...
def test_setup():
  ...
  TestName = "test_SelectFinalScenario"
  description = "This test scenario is to verify presence of elements inside Select Final Scenario"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Select Final Scenario"
            ii = 13
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Offer Scenario Chosen present in page-------------------------------
            Text1 = "Offer Scenario Chosen"
