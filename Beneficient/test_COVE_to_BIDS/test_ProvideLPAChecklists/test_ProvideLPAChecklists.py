...
def test_setup():
  ...
  TestName = "test_ProvideLPAChecklists"
  description = "This test scenario is to verify presence of elements inside Provide LPA Checklists"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Provide LPA Checklists"
            ii = 14
            try:
                driver.find_element_by_xpath(
            ...
            Text1 = "SAVE"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[2]/div/button").text
            try:
