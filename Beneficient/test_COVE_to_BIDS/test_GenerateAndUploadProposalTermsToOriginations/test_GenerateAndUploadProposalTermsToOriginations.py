...
def test_setup():
  ...
  TestName = "test_GenerateAndUploadProposalTermsToOriginations"
  description = "This test scenario is to verify presence of elements inside Generate and Upload Proposal Terms to Originations"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Generate and Upload Proposal Terms to Originations"
            ii = 12
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Proposal Term History present in page-------------------------------
            Text1 = "Proposal Term History"
            ...
            # ---------------------------------Upload Proposal Terms present in page-------------------------------
            Text1 = "Upload Proposal Terms"
            Element1 = driver.find_element_by_xpath(
