...
def test_setup():
  ...
  TestName = "test_AssignFunds"
  description = "This test scenario is to verify presence of elements inside Assign Funds"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
@pytest.mark.smoke
def test_AssignFunds(test_setup):
    if Exe == "Yes":
        SHORT_TIMEOUT = 5
        LONG_TIMEOUT = 400
        ...
        try:
            ...
            # ---------------------------------ASSIGN FUNDS (Button) present in page-------------------------------
            Text1 = "ASSIGN FUNDS"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[3]/button").text
            try:
