...
def test_setup():
  ...
  TestName = "test_DocumentRequestAndReceipt"
  description = "This test scenario is to verify presence of elements inside Document Request and Receipt"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Document Request and Receipt"
            ii = 6
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------CANCEL button present in page-------------------------------
            Text1 = "SAVE & SIGNOFF"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/button").text
            try:
