...
def test_setup():
  ...
  TestName = "test_UploadPostClosingDocuments"
  description = "This test scenario is to verify presence of elements inside Upload Post Closing Documents"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Upload Post Closing Documents"
            ii = 19
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Trust Agreements present in page-------------------------------
            Text1 = "Trust Agreements"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div").text
            try:
            ...
            Text1 = "Fund Name"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div/div[2]/div/div/table/thead/tr/th[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------Economic Direction Agreements present in page-------------------------------
            Text1 = "Economic Direction Agreements"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[2]/div[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------Notifications to GP present in page-------------------------------
            Text1 = "Notifications to GP"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[3]/div[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------GP Consent present in page-------------------------------
            Text1 = "GP Consent"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[4]/div[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------SAVE NOTES AND DOCUMENTS button present in page-------------------------------
            Text1 = "SAVE NOTES AND DOCUMENTS"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[5]/div/div[2]/div/button").text
            try:
