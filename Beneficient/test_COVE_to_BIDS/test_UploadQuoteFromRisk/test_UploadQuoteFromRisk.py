...
def test_setup():
  ...
  TestName = "test_UploadQuoteFromRisk"
  description = "This test scenario is to verify presence of elements inside Upload Quote from Risk"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Upload Quote from Risk"
            ii = 11
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Fund Name / Scenario present in page-------------------------------
            Text1 = "Fund Name / Scenario"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div/div[2]/div/div/div[2]/table/thead/tr[1]/th[1]/div").text
            try:
            ...
            # ---------------------------------Quote History present in page-------------------------------
            Text1 = "Quote History"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div/div/div/div[1]/div[2]/div/div/table/thead/tr[1]/th[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------Upload Quote present in page-------------------------------
            Text1 = "Upload Quote"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div/div/div/div[3]/div[1]/div/div[1]/span").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------QUOTE RECEIVED FROM RISK button present in page-------------------------------
            Text1 = "QUOTE RECEIVED FROM RISK"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div/div[2]/div/div/div/div/div[4]/div/div/div/button").text
            try:
