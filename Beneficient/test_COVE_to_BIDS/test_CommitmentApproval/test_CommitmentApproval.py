...
def test_setup():
  ...
  TestName = "test_CommitmentApproval"
  description = "This test scenario is to verify presence of elements inside Commitment Approval"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ---------------------------------Loan Policy Approval Guidelines (For Reference) present in page-------------------------------
            Text1 = "Loan Policy Approval Guidelines (For Reference)"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div/table/thead/tr[1]/th[1]/div").text
            try:
            ...
            # ---------------------------------Individual Approving present in page-------------------------------
            Text1 = "Individual Approving"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[4]/div[2]/div/div/table/thead/tr/th[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
