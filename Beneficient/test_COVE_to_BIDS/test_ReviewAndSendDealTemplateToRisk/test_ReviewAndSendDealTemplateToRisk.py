...
def test_setup():
  ...
  TestName = "test_ReviewAndSendDealTemplateToRisk"
  description = "This test scenario is to verify presence of elements inside Review and Send Deal Template to Risk"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Review and Send Deal Template to Risk"
            ii = 7
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Latest Deal Template present in page-------------------------------
            Text1 = "Latest Deal Template"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div/div[1]/div").text
            try:
            ...
            # ---------------------------------Fund⠀Name present in page-------------------------------
            Text1 = "Fund⠀Name"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div/div[2]/div/div/div[2]/div/div/div[2]/table/thead/tr/th[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------Deal Templates Version History present in page-------------------------------
            Text1 = "Deal Templates Version History"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
            ...
            # ---------------------------------DEAL TEMPLATE REVIEWED BY LEAD AND SENT TO RISK present in page-------------------------------
            Text1 = "DEAL TEMPLATE REVIEWED BY LEAD AND SENT TO RISK"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[2]/div[1]/div/div/button").text
            try:
            ...
            # ---------------------------------Template⠀Document⠀Filenames present in page-------------------------------
            Text1 = "Template⠀Document⠀Filenames"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[2]/div/div[2]/div/div/div[2]/div/div/div[2]/table/thead/tr[1]/th[1]/div").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
