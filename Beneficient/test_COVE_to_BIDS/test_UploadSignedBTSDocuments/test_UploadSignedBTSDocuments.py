...
def test_setup():
  ...
  TestName = "test_UploadSignedBTSDocuments"
  description = "This test scenario is to verify presence of elements inside Upload Signed BTS Documents"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Upload Signed BTS Documents"
            ii = 18
            try:
                driver.find_element_by_xpath(
            ...
            # ---------------------------------Signed Binding Term Sheet present in page-------------------------------
            Text1 = "Signed Binding Term Sheet"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div/div/div/div/div[1]/div/table/thead/tr/th[1]/div").text
            try:
            ...
            # ---------------------------------Upload Signed BTS present in page-------------------------------
            Text1 = "Upload Signed BTS"
            Element1 = driver.find_element_by_xpath(
                "//div[@class='ContentLayout---content_layout']/div[4]/div[2]/div/div[2]/div/div[1]/div[1]/div/div/div[3]/div[1]/div/div[1]/span").text
            try:
                assert Text1 in Element1, Text1 + " is not present"
                TestResult.append(
                    Text1 + " is present")
