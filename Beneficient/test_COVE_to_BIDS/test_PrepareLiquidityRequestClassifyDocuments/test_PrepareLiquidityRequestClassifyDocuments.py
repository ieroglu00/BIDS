...
def test_setup():
  ...
  TestName = "test_PrepareLiquidityRequestClassifyDocuments"
  description = "This test scenario is to verify presence of elements inside Prepare Liquidity Request - Classify Documents"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
...
def test_PrepareLiquidityRequest(test_setup):
    if Exe == "Yes":
        try:
            ...
            # ----------------------------------------------------------------------------------------
            PageName = "Prepare Liquidity Request - Classify Documents"
            ii = 5
            try:
                driver.find_element_by_xpath(
